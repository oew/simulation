...
public class JsonHelper {
	/**
	 * Convert the Json generic map of data to the class information using the
	 * classname to determine the java object to create.
	 * 
	...
	public static Object mapToClass(Map<String, Object> mapData) {
		...
		try {
			...
			System.out.println(
					"Invalid Classname " + classname + " check the simulation file for the correct trend." + "");
			e.printStackTrace();
